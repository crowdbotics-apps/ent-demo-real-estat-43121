...
function api_v1_address_create(payload) {
  return entdemorealestatAPI.post(`/api/v1/address/`, payload)
}
...
function api_v1_address_update(payload) {
  return entdemorealestatAPI.put(`/api/v1/address/${payload.id}/`, payload)
}
function api_v1_address_partial_update(payload) {
  return entdemorealestatAPI.patch(`/api/v1/address/${payload.id}/`, payload)
}
...
function api_v1_amenity_create(payload) {
  return entdemorealestatAPI.post(`/api/v1/amenity/`, payload)
}
...
function api_v1_amenity_update(payload) {
  return entdemorealestatAPI.put(`/api/v1/amenity/${payload.id}/`, payload)
}
function api_v1_amenity_partial_update(payload) {
  return entdemorealestatAPI.patch(`/api/v1/amenity/${payload.id}/`, payload)
}
function api_v1_amenity_destroy(payload) {
  return entdemorealestatAPI.delete(`/api/v1/amenity/${payload.id}/`)
}
function api_v1_login_create(payload) {
  return entdemorealestatAPI.post(`/api/v1/login/`, payload)
}
...
function api_v1_property_create(payload) {
  return entdemorealestatAPI.post(`/api/v1/property/`, payload)
}
...
function api_v1_property_update(payload) {
  return entdemorealestatAPI.put(`/api/v1/property/${payload.id}/`, payload)
}
function api_v1_property_partial_update(payload) {
  return entdemorealestatAPI.patch(`/api/v1/property/${payload.id}/`, payload)
}
function api_v1_property_destroy(payload) {
  return entdemorealestatAPI.delete(`/api/v1/property/${payload.id}/`)
}
function api_v1_signup_create(payload) {
  return entdemorealestatAPI.post(`/api/v1/signup/`, payload)
}
function rest_auth_login_create(payload) {
  return entdemorealestatAPI.post(`/rest-auth/login/`, payload)
}
...
function rest_auth_password_change_create(payload) {
  return entdemorealestatAPI.post(`/rest-auth/password/change/`, payload)
}
function rest_auth_password_reset_create(payload) {
  return entdemorealestatAPI.post(`/rest-auth/password/reset/`, payload)
}
function rest_auth_password_reset_confirm_create(payload) {
  return entdemorealestatAPI.post(`/rest-auth/password/reset/confirm/`, payload)
}
function rest_auth_registration_create(payload) {
  return entdemorealestatAPI.post(`/rest-auth/registration/`, payload)
}
...
function rest_auth_user_update(payload) {
  return entdemorealestatAPI.put(`/rest-auth/user/`, payload)
}
function rest_auth_user_partial_update(payload) {
  return entdemorealestatAPI.patch(`/rest-auth/user/`, payload)
}
