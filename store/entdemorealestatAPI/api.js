...
function api_v1_address_partial_update(payload) {
  return entdemorealestatAPI.patch(`/api/v1/address/${payload.id}/`, payload.data);
}
...
function api_v1_amenity_partial_update(payload) {
  return entdemorealestatAPI.patch(`/api/v1/amenity/${payload.id}/`, payload.data);
}
...
function api_v1_property_update(payload) {
  return entdemorealestatAPI.put(`/api/v1/property/${payload.id}/`, payload.data);
}

function api_v1_property_partial_update(payload) {
  return entdemorealestatAPI.patch(`/api/v1/property/${payload.id}/`, payload.data);
}
...
function rest_auth_password_reset_confirm_create(payload) {
  return entdemorealestatAPI.post(`/rest-auth/password/reset/confirm/`, payload.data);
}
...
function rest_auth_registration_verify_email_create(payload) {
  return entdemorealestatAPI.post(`/rest-auth/registration/verify-email/`, payload.data);
}
